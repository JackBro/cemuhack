...
#ifdef __EXP_DINPUT8
	if (wcscmp(szDllName, L"dinput8.dll") == 0)
	{
		FixSingleApi("DirectInput8Create", uAddr(API_EXPORT::DirectInput8Create));
		FixSingleApi("DllCanUnloadNow", uAddr(API_EXPORT::DllCanUnloadNow));
		FixSingleApi("DllGetClassObject", uAddr(API_EXPORT::DllGetClassObject));
		FixSingleApi("DllRegisterServer", uAddr(API_EXPORT::DllRegisterServer));
		FixSingleApi("DllUnregisterServer", uAddr(API_EXPORT::DllUnregisterServer));
...
#ifdef __EXP_DSOUND
	if (wcscmp(szDllName, L"dsound.dll") == 0)
	{
		FixSingleApi("DirectSoundCaptureCreate", uAddr(API_EXPORT::DirectSoundCaptureCreate));
		FixSingleApi("DirectSoundCaptureCreate8", uAddr(API_EXPORT::DirectSoundCaptureCreate8));
		FixSingleApi("DirectSoundCaptureEnumerateA", uAddr(API_EXPORT::DirectSoundCaptureEnumerateA));
    	FixSingleApi("DirectSoundCaptureEnumerateW", uAddr(API_EXPORT::DirectSoundCaptureEnumerateW));
		FixSingleApi("DirectSoundCreate", uAddr(API_EXPORT::DirectSoundCreate));
		FixSingleApi("DirectSoundCreate8", uAddr(API_EXPORT::DirectSoundCreate8));
		FixSingleApi("DirectSoundEnumerateA", uAddr(API_EXPORT::DirectSoundEnumerateA));
		FixSingleApi("DirectSoundEnumerateW", uAddr(API_EXPORT::DirectSoundEnumerateW));
		FixSingleApi("DirectSoundFullDuplexCreate", uAddr(API_EXPORT::DirectSoundFullDuplexCreate));
		FixSingleApi("DllCanUnloadNow", uAddr(API_EXPORT::DllCanUnloadNow));
		FixSingleApi("DllGetClassObject", uAddr(API_EXPORT::DllGetClassObject));
		FixSingleApi("GetDeviceID", uAddr(API_EXPORT::GetDeviceID));
	}
#endif 
...
void StartPatch()
{
	...
	else
	{
		CreateThread(nullptr, 0,
			LPTHREAD_START_ROUTINE(DLL_patch), hBase, 0, nullptr);
	}
#else
	DLL_patch(GetModuleHandle(nullptr));
#endif
...
#ifdef __EXP_DINPUT8
	dll_export DirectInput8Create(void) { PLACE_HOLDER(1); }
	dll_export DllCanUnloadNow(void) { PLACE_HOLDER(2); }
	dll_export DllGetClassObject(void) { PLACE_HOLDER(3); }
	dll_export DllRegisterServer(void) { PLACE_HOLDER(4); }
	dll_export DllUnregisterServer(void) { PLACE_HOLDER(5); }
	dll_export GetdfDIJoystick(void) { PLACE_HOLDER(6); }
#endif 

#ifdef __EXP_DSOUND
#pragma warning( disable : 4197 )  

	dll_export2 DirectSoundCaptureCreate(void) { PLACE_HOLDER(11); }
	dll_export2 DirectSoundCaptureCreate8(void) { PLACE_HOLDER(11); }
	dll_export2 DirectSoundCaptureEnumerateA(void) { PLACE_HOLDER(11); }
	dll_export2 DirectSoundCaptureEnumerateW(void) { PLACE_HOLDER(11); }
	    dll_export2 DirectSoundCreate() { PLACE_HOLDER(11); }
		dll_export2 DirectSoundCreate8() { PLACE_HOLDER(11); }
		dll_export2 DirectSoundEnumerateA(void) { PLACE_HOLDER(11); }
		dll_export2 DirectSoundEnumerateW(void) { PLACE_HOLDER(11); }
		dll_export2 DirectSoundFullDuplexCreate(void) { PLACE_HOLDER(11); }
		dll_export2 DllCanUnloadNow(void) { PLACE_HOLDER(2); }
		dll_export2 DllGetClassObject(void) { PLACE_HOLDER(3); }
		dll_export2 GetDeviceID() { PLACE_HOLDER(3); }
#endif 
